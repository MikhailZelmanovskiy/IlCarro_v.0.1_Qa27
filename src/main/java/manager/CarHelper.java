...
public class CarHelper extends HelperBase{
    ...
    public boolean isCarAdded() {
        new WebDriverWait(wd,10).until(ExpectedConditions.visibilityOf(wd.findElement(By.xpath("//h1[text()='Car added']"))));
        return isElementPresent(By.xpath("//h1[text()='Car added']"));
    }
}
